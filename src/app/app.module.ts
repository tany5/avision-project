...
import { NavigationAlertComponent } from './pages/navigation-alert/navigation-alert.component';
...
@NgModule({
  ...
  entryComponents: [MessageDialougeComponent,HomepopupComponent,PlanpopupComponent,SchollarComponent,ScholarregisterComponent,AtseComponent,AtseThanksComponent,ThankyouliveclassComponent,PassSuccessComponent,NavigationAlertComponent,LoginPopupComponent]
